...
def count_change(amount, denominations):
    ...
    if amount == 0:
      return 1
    first_case = count_change(amount - first(denominations), denominations)
    re_case = count_change(amount, rest(denominations))
    return first_case + re_case
